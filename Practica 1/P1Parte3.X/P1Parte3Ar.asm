...
INICIO:	    NOP ;Deja pasar un ciclo. Es necesario para dejar pasar el ciclo que toma la instruccion no nativa
	    BANKSEL	ANSELH ;se mueve al banco de ansel
	    CLRF	ANSELH;pone ansel en 0's, es decir, todos los puertos son digitales
	    BANKSEL	TRISB ;se mueve al banco de trisa
	    MOVLW	B'00000000' ;carga en w el numero indicado
	    MOVWF	TRISB ;escribe el contenido de w en trisa, como todos son 0s, los hace salidas}
	    BANKSEL	PORTB ;se mueve al banco de porta
            ;GOTO        REPETIR
REPETIR:    NOP
            CLRF	PORTB ;pone todo porta en 0´s
